        ...
        children: [
          ...
          Column(
            children: [
              ...
              Obx(() => GestureDetector(
                onTap: () {
                  _controller.setStringData('hear_about_us', 'facebook');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 20),
                  margin: const EdgeInsets.only(bottom: 16),
                  decoration: BoxDecoration(
                    color: _controller.getStringData('hear_about_us') == 'facebook' 
                        ? CupertinoColors.black
                        : CupertinoColors.white,
                    border: Border.all(
                      color: _controller.getStringData('hear_about_us') == 'facebook'
              ...
              Obx(() => GestureDetector(
                onTap: () {
                  _controller.setStringData('hear_about_us', 'google');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 20),
                  margin: const EdgeInsets.only(bottom: 16),
                  decoration: BoxDecoration(
                    color: _controller.getStringData('hear_about_us') == 'google' 
                        ? CupertinoColors.black
                        : CupertinoColors.white,
                    border: Border.all(
                      color: _controller.getStringData('hear_about_us') == 'google'
